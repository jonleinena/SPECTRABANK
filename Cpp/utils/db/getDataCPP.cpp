...
containers::Inversiones *getInversiones(string dni)
{
    ...
    {
        inversiones->setInversion(i, new containers::Inversion((const char *)sqlite3_column_text(res, 1), sqlite3_column_double(res, 2), sqlite3_column_double(res, 3), (const char *)sqlite3_column_text(res, 4)));
        i++;
    }
